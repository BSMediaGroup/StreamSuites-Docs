        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/changelog/v0-4-0-alpha',
                component: ComponentCreator('/docs/changelog/v0-4-0-alpha', 'd3c'),
                exact: true,
                sidebar: "docs"
              },
              {
              ...
              {
                path: '/docs/find-me-here/advanced-css',
                component: ComponentCreator('/docs/find-me-here/advanced-css', 'fd0'),
                exact: true,
                sidebar: "docs"
              },
              {
